...
packer build -var-file="/home/fedora/code/gopath/src/sigs.k8s.io/capi-dev/image-builder/images/capi/packer/config/kubernetes.json"  -var-file="/home/fedora/code/gopath/src/sigs.k8s.io/capi-dev/image-builder/images/capi/packer/config/cni.json"   -var-file="/home/fedora/code/gopath/src/sigs.k8s.io/capi-dev/image-builder/images/capi/packer/ova/ova-ubuntu-1804.json" -on-error=ask packer/ova/packer.json
````
...
```bash
qemu-img convert -f vmdk -O qcow2 ./output/ubuntu-1804+kube-v1.15.0/ubuntu-1804.ova.vmdk ./output/ubuntu-1804+kube-v1.15.0/ubuntu-1804.ova.qcow2
...
openstack image create --disk-format vmdk \
  ...
  --file ./output/ubuntu-1804+kube-v1.15.0/ubuntu-1804.ova.vmdk ubuntu-1804-kube-v1.15.0

dhc_openstack cluster-api-testing
openstack image create --disk-format qcow2 \
  --private \
  --container-format bare \
  --file ./output/ubuntu-1804+kube-v1.15.0/ubuntu-1804.ova.qcow2 ubuntu-1804-kube-v1.15.0
