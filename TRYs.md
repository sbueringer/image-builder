...
# qcow2 => vmdk
qemu-img convert -f qcow2 -O vmdk -o subformat=streamOptimized./output/ubuntu-1804-kube-v1.16.2/ubuntu-1804.ova.qcow2 ./output/ubuntu-1804-kube-v1.16.2/ubuntu-1804.ova.vmdk
